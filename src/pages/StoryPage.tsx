...
export default function StoryPage() {
  ...
  // NOTE: Manually formatting 'i' for the closest approximation of the requested effect.
  // The 'i' in the story text has been manually replaced with <b>i</b> to make it visually distinct.
  // The 'mother' image is referenced by the assumed public path /mother.jpg.
          ...
          >
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-2xl">
              ...
              <div className="prose prose-lg max-w-none">
                {/* 🔴 Apply red text effect on bolded letters for visual distinction */}
                <p className="text-gray-800 leading-relaxed text-lg whitespace-pre-wrap font-serif">
                  <span dangerouslySetInnerHTML={{ __html: displayedText.replace(/<b>i<\/b>/g, '<span style="color: red; font-weight: bold;">i</span>') }} />
